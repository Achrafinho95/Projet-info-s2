...
class ServerGUI:
    def __init__(self, root):
        ...
        self.clients = []
        self.key = b'mon_super_secret'  # clé de 16 octets pour AES
        self.start_server()
    ...
    def handle_client(self, conn, addr):
        while True:
            ...
            self.chat_box.insert(tk.END, f"Client : {decrypted_data}\n")
        conn.close()
    ...
    def send_message(self):
        ...
        if message:
            self.chat_box.insert(tk.END, f"Serveur : {message}\n")
    ...
    def encrypt_message(self, message):
        ...
        return cipher.iv + cipher_text  # Préfixer l'IV
